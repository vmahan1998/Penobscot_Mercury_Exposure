...
This section documents the logic and equations underlying seaward (downstream) migration. The modeled behavior accounts for the physical challenge of swimming with riverine flows and against tidal flows. Empirically this is very similar to the Landward Migration behavior, with a positive scaling factor instead of negative.
...
-   $\hat{u}$ is the unit vector in the seaward direction (180° heading, upstream).
